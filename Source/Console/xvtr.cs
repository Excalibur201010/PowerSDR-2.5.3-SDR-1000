...
namespace PowerSDR
{
	public class XVTRForm : System.Windows.Forms.Form
	{
        ...
        private Label label_VUModuleNotPresent;//
        private Label label_VUModulePresent;//
        private LabelTS lblIFGain;//
        private LabelTS lblPAEnable;//
        private CheckBoxTS chkVHFIFGain;//
        private CheckBoxTS chkUHFIFGain;//
