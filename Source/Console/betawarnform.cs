...
namespace PowerSDR
{
	public class BetaWarnForm : System.Windows.Forms.Form
	{
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BetaWarnForm));
            ...
            this.rtxtWarning.TextChanged += new System.EventHandler(this.rtxtWarning_TextChanged);
            // 
            ...
            this.Name = "BetaWarnForm";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Beta Warning";
            this.Closing += new System.ComponentModel.CancelEventHandler(this.BetaWarnForm_Closing);
		...
		private void BetaWarnForm_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			this.Hide();
			if(!chkShowThisOnStartup.Checked)
			{
				ArrayList a = new ArrayList();
				a.Add("show_beta_warning/False");
				DB.SaveVars("State", ref a);
			}
		}

        private void rtxtWarning_TextChanged(object sender, EventArgs e)
        {
