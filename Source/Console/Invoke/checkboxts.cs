...
// checkboxts.cs
//=================================================================
// This file implements a thread-safe CheckBox control based on the
...
{
	public class CheckBoxTS : CheckBox
	{
		#region Properties
		...
		public new Appearance Appearance
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetCheckBoxAppearance), new object[] {this, value});
				else base.Appearance = value;
			}
		}
		...
		public new bool AutoCheck
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetCheckBoxAutoCheck), new object[] {this, value});
				else base.AutoCheck = value;
			}
		}
		...
		public new ContentAlignment CheckAlign
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetCheckBoxCheckAlign), new object[] {this, value});
				else base.CheckAlign = value;
			}
		}
		...
		public new bool Checked
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetCheckBoxChecked), new object[] {this, value});
				else base.Checked = value;
			}
		}
		...
		public new CheckState CheckState
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetCheckBoxCheckState), new object[] {this, value});
				else base.CheckState = value;
			}
		}
		...
		public new FlatStyle FlatStyle
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetButtonBaseFlatStyle), new object[] {this, value});
				else base.FlatStyle = value;
			}
		}
		...
		public new Image Image
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetButtonBaseImage), new object[] {this, value});
		...
		public new ContentAlignment ImageAlign
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetButtonBaseImageAlign), new object[] {this, value});
				else base.ImageAlign = value;
			}
		}
		...
		public new int ImageIndex
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetButtonBaseImageIndex), new object[] {this, value});
				else base.ImageIndex = value;
			}
		}
		...
		public new ImageList ImageList
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetButtonBaseImageList), new object[] {this, value});
				else base.ImageList = value;
			}
		}
		...
		public new ImeMode ImeMode
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetButtonBaseImeMode), new object[] {this, value});
		...
		public new string Text
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetControlText), new object[] {this, value});
		...
		public override ContentAlignment TextAlign
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetButtonBaseTextAlign), new object[] {this, value});
		...
		public new bool ThreeState
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetCheckBoxThreeState), new object[] {this, value});
				else base.ThreeState = value;
			}
		}
