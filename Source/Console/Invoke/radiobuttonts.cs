...
// radiobuttonts.cs
//=================================================================
// This file implements a thread-safe RadioButton control based on the
...
{
	public class RadioButtonTS : RadioButton
	{
		#region Properties
		...
		public new Appearance Appearance
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetRadioButtonAppearance), new object[] {this, value});
		...
		public new bool AutoCheck
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetRadioButtonAutoCheck), new object[] {this, value});
		...
		public new ContentAlignment CheckAlign
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetRadioButtonCheckAlign), new object[] {this, value});
		...
		public new bool Checked
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetRadioButtonChecked), new object[] {this, value});
		...
		public override ContentAlignment TextAlign
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetRadioButtonTextAlign), new object[] {this, value});
