...
// labelts.cs
//=================================================================
// This file implements a thread-safe Label control based on the
...
namespace System.Windows.Forms
{
	public class LabelTS : Label
	{
		...
		public new virtual bool AutoSize
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelAutoSize), new object[] {this, value});
		...
		public new BorderStyle BorderStyle
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelBorderStyle), new object[] {this, value});
		...
		public new FlatStyle FlatStyle
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelFlatStyle), new object[] {this, value});
		...
		public new Image Image
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelImage), new object[] {this, value});
		...
		public new ContentAlignment ImageAlign
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelImageAlign), new object[] {this, value});
		...
		public new int ImageIndex
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelImageIndex), new object[] {this, value});
		...
		public new ImageList ImageList
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelImageList), new object[] {this, value});
		...
		public new string Text
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelText), new object[] {this, value});
		...
		public new virtual ContentAlignment TextAlign
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelTextAlign), new object[] {this, value});
		...
		public new bool UseMnemonic
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetLabelUseMnemonic), new object[] {this, value});
				else base.UseMnemonic = value;
			}
		}
