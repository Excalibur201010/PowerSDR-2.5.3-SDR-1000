...
// groupboxts.cs
//=================================================================
// This file implements a thread-safe GroupBox control based on the
...
{
	public class GroupBoxTS : GroupBox
	{
		#region Properties
		...
		public new bool AllowDrop
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetGroupBoxAllowDrop), new object[] {this, value});
		...
		public new FlatStyle FlatStyle
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetGroupBoxFlatStyle), new object[] {this, value});
		...
		public new string Text
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetGroupBoxText), new object[] {this, value});
