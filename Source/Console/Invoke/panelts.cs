...
// panelts.cs
//=================================================================
// This file implements a thread-safe Panel control based on the
...
namespace System.Windows.Forms
{
	public class PanelTS : Panel
	{
		...
		public new BorderStyle BorderStyle
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetPanelBorderStyle),
						new object[] { this, value });
		...
		public new bool TabStop
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetPanelTabStop), new object[] {this, value});
		...
		public new string Text
		{
			...
			{
				if(base.InvokeRequired)
					this.Invoke(new UI.SetCtrlDel(UI.SetPanelText), new object[] {this, value});
